...
/**
 * sfWordnikExample filter form base class.
 *
 * @package    greight
 * @subpackage filter
 ...
 */
abstract class BasesfWordnikExampleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sf_wordnik_example_filters[%s]');
